...
//--------------------------------------------------------------------------
static inline void EnableUsbIRQ (void)
{
	nvic_irq_enable(NVIC_USB_LP_CAN_RX0);
}
//--------------------------------------------------------------------------
static inline void DisableUsbIRQ (void)
{
...
// Bootloader size
#define BOOTLOADER_SIZE		(3 * PAGE_SIZE)

// SRAM size
#define SRAM_SIZE			(40 * 1024)	// the 8kB CDC RAM is not used
